...
namespace Softeq.NetKit.Services.PushNotifications.Factories
{
    ...
    {
        private const string iOSTemplate = "{\"aps\":{\"alert\":{\"title-loc-key\":\"$(title_loc_key)\", \"title-loc-args\":[\"$(title_loc_args)\"], \"loc-key\":\"$(body_loc_key)\", \"loc-args\":[\"$(body_loc_args)\"], \"title\":\"$(title)\", \"body\":\"$(body)\"}, \"sound\":\"$(sound)\", \"badge\":\"#(badge)\", \"type\":\"#(type)\"}, \"data\":\"$(data)\"}";
        private const string androidTemplate = "{\"notification\":{\"title_loc_key\":\"$(title_loc_key)\", \"title_loc_args\":\"$(title_loc_args)\", \"body_loc_key\":\"$(body_loc_key)\", \"body_loc_args\":\"$(body_loc_args)\", \"body\":\"$(body)\", \"title\":\"$(title)\", \"sound\":\"$(sound)\"}, \"data\":{\"type\":\"#(type)\", \"payload\":\"$(data)\"}}";
